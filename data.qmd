  ...
  <section class="section-block">
    ...
    <div class="feature-layout">
      <figure class="feature-figure">
        ...
        <figcaption>Forest cover, scheduled status, spatial matching, and local governance data</figcaption>
      </figure>
      <div class="card-stack">
        <article class="entry-card">
          <h3>Historical VCF at SHRID Level, 1982-2016</h3>
          <div class="meta-row">
            <span class="pill alt">Development Data Lab, 2026</span>
            <a class="link-pill" href="https://www.devdatalab.org/shrug_download/">SHRUG Download</a>
            <details class="inline-toggle">
              <summary>Dataset Details</summary>
              <div class="toggle-panel">
                <ul class="clean-list">
                  <li>Historical forest-cover data at the SHRUG SHRID level covering 1982-2016.</li>
                </ul>
              </div>
            </details>
          </div>
