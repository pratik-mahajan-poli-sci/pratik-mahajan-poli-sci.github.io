...
<img src="landing page image.jpg" width="300px"/>
:::
...
<img src="cso endorse.jpg" width="300px"/>

**How Discretion Shapes Civil Society--Opposition Party Alliances Against Democratic Backsliding** [With <a href="https://www.feyaadallie.com/">Feyaad Allie</a> — (Working Paper)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
**When Civil Society Overreaches: Voter Aversion to Expansive Civil Society Electoral Mobilization** [With <a href="https://www.feyaadallie.com/">Feyaad Allie</a> — (Working Paper)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
**Integrating Citizen Awareness into the Study of Democratic Backsliding** [With <a href="(https://alyssaheinze.github.io/"> Alyssa Heinze</a> — (Working Paper)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
<img src="pw training.jpg" width="300px"/>

**Brokered Majoritarianism: Turncoat Minority Politicians and Mixed Returns to Ideological Transformation** [(Working Paper under review)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
**Aspirational Tolerance: Political Ambition And Tolerance of Dynastic Politicians** [With <a href="(https://cprindia.org/people/rahul-verma/">Rahul Verma</a> — (Working Paper under review)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
**Ambition and Ascent: How Formal Positions Shape Party Worker Attitudes** [With <a href="https://www.feyaadallie.com/">Feyaad Allie</a> and <a href="https://cprindia.org/people/rahul-verma/">Rahul Verma</a> — (Working Paper)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
...
**Disproportionate Vacancy: How Bias and Selective Mobilization Shape Vacancies in India's Village Councils** [With <a href="https://alyssaheinze.github.io/">Alyssa Heinze</a> — (Work in Progress)]{.coauthor-note} <button class="abstract-toggle" onclick="toggleAbstract(this)">Abstract</button>
